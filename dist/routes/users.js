...
router.post('/match-contacts', auth_1.authenticate, [(0, express_validator_1.body)('phones').isArray({ min: 1 }).withMessage('phones must be a non-empty array')], validate_1.validate, userController_1.matchContacts);
