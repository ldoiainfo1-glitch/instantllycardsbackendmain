...
router.patch('/:id/status', auth_1.authenticate, [(0, express_validator_1.body)('status').notEmpty()], validate_1.validate, h(voucherController_1.updateVoucherStatus));
router.post('/redeem', auth_1.authenticate, [(0, express_validator_1.body)('voucher_id').isInt()], validate_1.validate, h(voucherController_1.redeemVoucher));
