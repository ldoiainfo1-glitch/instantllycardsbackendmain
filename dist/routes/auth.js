...
], validate_1.validate, h(authController_1.signup));
...
], validate_1.validate, h(authController_1.login));
router.post('/refresh', authRateLimit, h(authController_1.refresh));
router.post('/logout', auth_1.authenticate, h(authController_1.logout));
router.get('/me', auth_1.authenticate, h(authController_1.me));
...
], validate_1.validate, h(authController_1.changePassword));
